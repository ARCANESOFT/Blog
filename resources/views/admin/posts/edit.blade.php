            ...
            <div class="col-md-8 col-lg-9">
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <a href="{{ route('admin::blog.posts.show', [$post]) }}" class="btn btn-sm btn-default">
                            Cancel
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-12">
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                {{ Form::select('tags[]', $tags, old('tags', $post->tags->pluck('id')->toArray()), ['class' => 'form-control', 'multiple' => 'multiple', 'data-placeholder' => 'Select a tag', 'style' => 'width: 100%;']) }}
                                @if ($errors->has('tags'))
