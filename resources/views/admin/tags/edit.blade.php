...
@section('content')
    <div class="row">
        <div class="col-md-4">
            {{ Form::open(['route' => ['admin::blog.tags.update', $tag], 'method' => 'PUT', 'id' => 'updateTagForm', 'class' => 'form form-loading']) }}
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <a href="{{ route('admin::blog.tags.index') }}" class="btn btn-sm btn-default">
                            Cancel
                        </a>
