        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <div class="btn-group" role="group">
                    <a href="{{ route('blog::foundation.tags.index') }}" class="btn btn-xs btn-default {{ route_is('blog::foundation.tags.index') ? 'active' : '' }}">
                        <i class="fa fa-fw fa-bars"></i> All
                    </a>
                    <a href="{{ route('blog::foundation.tags.trash') }}" class="btn btn-xs btn-default {{ route_is('blog::foundation.tags.trash') ? 'active' : '' }}">
                        <i class="fa fa-fw fa-trash-o"></i> Trashed
                    </a>
                </div>

                <a href="{{ route('blog::foundation.tags.create') }}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-original-title="Add">
                        ...
                        @if ($tags->count())
                            @foreach($tags as $tag)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('blog::foundation.tags.show', [$tag->id]) }}" class="btn btn-xs btn-info" data-toggle="tooltip" data-original-title="Show">
                                            <i class="fa fa-fw fa-search"></i>
                                        </a>
                                        <a href="{{ route('blog::foundation.tags.edit', [$tag->id]) }}" class="btn btn-xs btn-warning" data-toggle="tooltip" data-original-title="Edit">
...
@section('scripts')
    @if ($trashed)
        ...
        <script>
            var restoreTagModal = $('div#restoreTagModal'),
                ...
                restoreTagUrl   = "{{ route('blog::foundation.tags.restore', [':id']) }}";

            $('a[href="#restoreTagModal"]').click(function (event) {
                event.preventDefault();
                var modalMessage = 'Are you sure you want to <span class="label label-primary">restore</span> this tag : <strong>:tag</strong> ?';
    ...
    <script>
        var deleteTagModal = $('div#deleteTagModal'),
            ...
            deleteTagUrl   = "{{ route('blog::foundation.tags.delete', [':id']) }}";

        $('a[href="#deleteTagModal"]').click(function (event) {
            event.preventDefault();
            var modalMessage = 'Are you sure you want to <span class="label label-danger">delete</span> this tag : <strong>:tag</strong> ?';
